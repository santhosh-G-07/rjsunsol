...
export default function AboutHeroSection() {
  ...
  return (
    <section className="relative min-h-screen h-screen overflow-hidden pt-16 md:pt-[76px]" style={{ minHeight: "100vh" }}>
      {/* Background: parallax + Ken Burns (disabled when reduced motion) */}
      <div className="pointer-events-none absolute inset-0">
        {shouldReduceMotion ? (
          <ImageWithSkeleton
            src={ASSET_PATHS.sectionBgBluehour}
            alt="Solar plant at blue hour"
            fill
            priority
      ...
      <div className="relative z-10 flex h-full w-full flex-col items-center justify-center">
        <div className="container-custom">
          <div className="mx-auto max-w-[800px] text-center">
            ...
            {/* Heading */}
            <div className="mt-6">
              {["Built on Engineering", "Powered by Purpose"].map(
                (line, idx) => (
                  <motion.div
                    key={line}
            ...
            >
              From a single project in Tamil Nadu to over 100MW of commissioned
              solar energy — our story is one of technical excellence, trusted
              partnerships, and an unwavering commitment to India&apos;s clean
              energy future.
            </motion.p>
          </div>
        </div>
